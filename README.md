...
- Cosmos SDK 를 이용한 앱체인 개발도 가능합니다. 개발 방법론적인 측면에서 cosmos 앱체인과 여타 범용 블록체인의 차이점을 확실히 인지하고 있으며, cosmos 본연의 앱체인 개발설계가 가능합니다. ethermint 모듈을 올려 evm 호환가능한 cosmos 앱체인 또한 만들 수 있습니다.
